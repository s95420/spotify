...
export const options = {
  plugins: {
    title: {
      display: true,
      text: "Popularność artystów w kategorii Top200 - Polska",
      font: {
        size: 15,
        weight: "bold",
      },
...
export const Top200PolandChart = () => {
  ...
  const xLabels = [];
  const yLabels = [];
  const apiURL = `http://localhost:8080/api/v1/top200/Poland?page=${page}&sortDate=DESC&sortRank=ASC`;
...
export default Top200PolandChart;
